...
# JANELA 
label_cadastro = Label(janela, text='Cadastro de professores/instrutores', fg='orange', bg='white', font=('Arial','30'), justify='center')
label_cadastro.pack(side=TOP)

# FRAME 1 
label_ra = Label(frame1, text='CPF do professor', fg='blue', bg='white', font=('','14'))
label_ra.place(x=50,y=80)

entry_ra = Entry(frame1, font=('Arial','12'), relief='solid')
entry_ra.place(x=331, y=82, height=28)
entry_ra['state'] = 'disabled'

label_nome = Label(frame1, text='Nome', fg='blue', bg='white', font=('','14'))
...
label_numero = Label(frame1, text='Bairro', fg='blue', bg='white', font=('','14'))
label_numero.place(x=26,y=160)

entry_numero = Entry(frame1, font=('Arial','12'), relief='solid')
entry_numero.place(x=175,y=162,height=28)

label_numero = Label(frame1, text='Cidade', fg='blue', bg='white', font=('','14'))
label_numero.place(x=26,y=160)
...
label_cursoaluno = Label(frame1, text='UF', fg='blue', bg='white', font=('','14'))
...
#crollbar_y = ttk.Scrollbar(frame2,orient='vertical', command=tree_ferramentas.yview)
...
botao_inserir.place(x=400,y=300,width=80,height=30)
