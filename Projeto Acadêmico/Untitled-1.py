...
comando_sql_criar_table = "CREATE TABLE IF NOT EXISTS `alunospy` (CPF_aluno` int NOT NULL AUTO_INCREMENT,`nome_aluno` varchar(80) NOT NULL,`CEP` varchar(11) NOT NULL,`endereço` date NOT NULL,`cidade` varchar(60) NOT NULL, PRIMARY KEY (`UF`)) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci"
comando_sql_inserir = "INSERT INTO alunospy (CPF_aluno, nome_aluno, CEP, endereço, cidade, UF) VALUES(%s, %s, %s, %s)"
comando_sql_select = "SELECT * FROM alunospy;"
comando_sql_seguranca = "SET SQL_SAFE_UPDATES = 0;"
comando_sql_deletar = "DELETE FROM alunospy WHERE CPF_aluno=%s;"
...
# JANELA 
label_cadastro = Label(janela, text='Cadastro de alunos do curso de TI', fg='yellow', bg='white', font=('Arial','30'), justify='center')
label_cadastro.pack(side=TOP)

# FRAME 1 
label_ra = Label(frame1, text='CPF do aluno', fg='blue', bg='white', font=('','14'))
...
label_numero = Label(frame1, text='CEP', fg='blue', bg='white', font=('','14'))
...
label_datanasc = Label(frame1, text='Endereço', fg='blue', bg='white', font=('','14'))
...
label_cursoaluno = Label(frame1, text='Cidade', fg='blue', bg='white', font=('','14'))
...
label_ra = Label(frame1, text='UF', fg='blue', bg='white', font=('','14'))
label_ra.place(x=50,y=80)
...
colunas_ferramentas = ('CPF_aluno','nome_aluno','CEP','endereço','cidade','UF')
tree_ferramentas = ttk.Treeview(frame2, columns=colunas_ferramentas, show='headings')

tree_ferramentas.column("CPF_aluno", width=55,anchor=CENTER, minwidth=55, stretch=NO)
tree_ferramentas.column("nomealuno", width=150,anchor=CENTER, minwidth=150, stretch=NO)
tree_ferramentas.column("CEP", width=75,anchor=CENTER, minwidth=75, stretch=NO)
tree_ferramentas.column("endereço", width=80,anchor=CENTER, minwidth=80, stretch=NO)
tree_ferramentas.column("cidade", width=150,anchor=CENTER, minwidth=150, stretch=NO)
tree_ferramentas.column("UF", width=150,anchor=CENTER, minwidth=150, stretch=NO)


tree_ferramentas.heading('CPF_aluno', text='CPF do aluno')
tree_ferramentas.heading('nomealuno', text='Nome do aluno')
tree_ferramentas.heading('CPF', text='CPF')
tree_ferramentas.heading('endereço', text='Endereço')
tree_ferramentas.heading('cidade', text='Cidade')
tree_ferramentas.heading('UF', text='UF')
